          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 items-start">
            ...
            <div className="flex flex-col pt-12">
              ...
              <p className="text-sm text-[#57534e] leading-relaxed font-hei">
                공간을 채우는 따스한 빛과 정적 속에서 탄생하는 늘:pepi-i의 분위기는 세월이 흘러도 변하지 않는 우아함을 지향합니다.
              </p>
            </div>
            ...
            <div className="flex flex-col md:translate-y-32">
              ...
              <p className="text-sm text-[#57534e] leading-relaxed font-hei">
                숙련된 늘:pepi-i 장인들의 섬세한 손길로 완성되는 한 벌 한 벌은 단순한 의복을 넘어 당신의 일상에 특별한 감각을 더합니다.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="flex items-center gap-12 mb-24 relative">
                <div className="flex-1 text-right">
                  ...
                  <p className="text-sm text-[#78716c] font-hei">성수동 작은 작업실에서 시작된<br />늘:pepi-i의 첫 번째 컬렉션</p>
                </div>
              ...
              <div className="flex items-center gap-12 mb-24 relative">
                ...
                <div className="z-10 w-4 h-4 rounded-full bg-black ring-8 ring-white" />
                <div className="flex-1">
                  <h4 className="text-xl font-serif mb-2">늘:pepi-i 확장</h4>
        ...
        <section className="max-w-[1280px] mx-auto px-8 py-32 border-t border-black/5">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="flex flex-col gap-12">
              <div>
                <h2 className="text-4xl font-serif mb-6">성수 늘:pepi-i</h2>
                <p className="text-[#78716c] leading-relaxed font-hei mb-10">
                  성수동의 고요한 골목 끝, 늘:pepi-i의 모든 영감이 시작되는 공간입니다. 예약제로 운영되는 늘:pepi-i 방문을 통해 늘:pepi-i만의 무드를 직접 경험해보세요.
                </p>
